    ...
    <main className="min-h-[calc(100vh-65px)] bg-gray-50 px-4 py-12">
      <section className="mx-auto max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900">마이페이지</h2>
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-md bg-blue-50 px-3 py-1 text-sm text-blue-600">useState</span>

              <span className="rounded-md bg-purple-50 px-3 py-1 text-sm text-purple-600">useReducer</span>

              <span className="rounded-md bg-green-50 px-3 py-1 text-sm text-green-600">useContext</span>

              <span className="rounded-md bg-orange-50 px-3 py-1 text-sm text-orange-600">React Router</span>
            </div>
          </div>
        </div>
